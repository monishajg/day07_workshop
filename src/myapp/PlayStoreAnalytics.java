...
public class PlayStoreAnalytics {
    ...
    public static final void main(String[] args) throws Exception {
        ...
        Reader r = new FileReader("googleplaystore.csv");       // 1. create reader for .csv (which is placed in folder abv)
        BufferedReader br = new BufferedReader(r);                          // 2. get buffered reader to obtain line

        List<App> apps = br.lines()                                         // 3. look at java doc> stream> line
